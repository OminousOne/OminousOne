...
<a name="netcode"></a><a href="https://readme-ominousones-projects.vercel.app/play" title="play pong with simulated lag"><img src="./assets/card-netcode.svg" width="49.4%" alt="Multiplayer netcode: networking from scratch in C# with client prediction, server reconciliation, and interpolation. Click to play pong with simulated lag and toggleable client prediction." /></a> <a href="https://github.com/OminousOne?tab=repositories" title="my repositories"><img src="./assets/card-earlier.svg" width="49.4%" alt="Earlier work, 2018 to 2024: years of Minecraft server plugins in Java and Kotlin, including Conway's Game of Life inside Minecraft, and Tailor, an OS flashing tool. Click for my repos." /></a>
